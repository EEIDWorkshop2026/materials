...
https://github.com/EEIDWorkshop2026/materials/tree/main/data_management
...
- **Store in the class folder that you can find!**
- Each class --double click klangwig.Rproj and pull
- Open the R script 2_data_management_tidyverse.R so you can run it while I talk
...
- Determine what your data points/observations/sampling units are (individual insect trap)
